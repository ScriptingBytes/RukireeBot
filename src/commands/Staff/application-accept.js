...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        .setColor(`Orange`)
        .setDescription(`<:Checkmark:1125943017434525776> <@${user.id}>'s application has been succesfully accepted and they are now a part of Rukiree staff team!`)
        .setTimestamp()

        const accembeduser = new EmbedBuilder()
        .setTitle(`Rukiree Staff Applications`)
        .setColor(`Orange`)
        .setDescription(`Hello <@${user.id}>, You are now a part of the Rukiree staff team as a **${position}** <a:PartyPopper:1125906182079533107>`)
        .setTimestamp()
