...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const alreadyticketEmbed = new EmbedBuilder().setDescription(config.ticketAlreadyExist).setColor('Orange')
        ...
        try {
            await guild.channels.create({
                ...
                const embed = new EmbedBuilder().setTitle(config.ticketMessageTitle).setDescription(config.ticketMessageDescription).setColor(`Orange`)
                ...
                const ticketmessage = new EmbedBuilder().setDescription(config.ticketCreate + ' <#' + channel.id + '>').setColor('Orange');
